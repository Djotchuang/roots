      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav mr-auto">
            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>"><span><ion-icon style="font-size:1.5rem !important; margin-right:.2em !important; margin-bottom:-.18em !important" name="home-outline"></ion-icon></span>Home</a></li>
             <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>posts"><span><ion-icon style="font-size:1.5rem !important; margin-right:.2em !important; margin-bottom:-.18em !important" name="duplicate-outline"></span>Newsfeed</a></li>
             <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>countries"><span><ion-icon style="font-size:1.5rem !important; margin-right:.2em !important; margin-bottom:-.18em !important" name="earth-outline"></span>Countries</a></li>
          </ul>
          ...
          <?php if ($this->session->userdata('logged_in')): ?>
           <form action="<?=base_url();?>users/fetch" method="post" id="search-form"  class="form-inline my-2 my-lg-0">
            ...
            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>posts/create"><ion-icon name="create-outline"></ion-icon></a></li>
            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>countries/create"><ion-icon name="notifications-outline"></ion-icon></a></li>
            <li class="nav-item dropdown">
             <a class="nav-link dropdown-toggle" id="profile-icon" data-toggle="dropdown" role="button" href="#" aria-haspopup="true" aria-expanded="false"><ion-icon name="person-circle-outline"></ion-icon></a>
