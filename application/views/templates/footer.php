      ...
      <form id="chat_form" class="bg-light">
        <div class="input-group">
          ...
          <div class="input-group-append">
            <button id="button-addon2" type="submit" class="btn btn-primary"> <ion-icon style="color:white !important; font-size:1.5em;" name="send-outline"></ion-icon></button>
		  </div>
        </div>
	   </form>
				...
				$('#chat_form').on('submit', function(){
				  if(chat_msg != ''){
                   ...
                   $.ajax({
					   ...
					   type: 'post',
					   data:{'message':chat_msg, 'reciever_name':reciever_name},
					   beforeSend:function(){
